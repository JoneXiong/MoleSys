...
from mocrud.auth import Auth, BaseUser
from mocrud.db import Database
from mocrud.filters import QueryFilter
from mocrud.rest import RestAPI, RestResource, RestrictOwnerResource, UserAuthentication, AdminAuthentication, APIKeyAuthentication, Authentication
from mocrud.utils import get_object_or_404, object_list, make_password
...
app.config.from_object('mocrud.tests.test_config.Configuration')
